#ifndef SKYBLIP_PRODUCTS_SKYBLIP_GO_PAGES_SETTINGS_H
#define SKYBLIP_PRODUCTS_SKYBLIP_GO_PAGES_SETTINGS_H
...
void draw_settings(ui::Canvas& fb, const SettingsSnapshot& snapshot);
