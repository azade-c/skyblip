...
From `Info` up - the grade that fills the diamond - the sector the threat lies in is inverted and flashes: a 45 degree pie cut with its apex at own ship, out to the range ring, black and white and black again, once a second. It is the one mark on the page a pilot does not have to read. Where a bar across the top of the glass said only that something was urgent, the wedge says which way to look, which is the whole instruction this device is able to give.
