...
#ifndef SKYBLIP_PRODUCTS_SKYBLIP_GO_PAGES_CONFIRM_H
#define SKYBLIP_PRODUCTS_SKYBLIP_GO_PAGES_CONFIRM_H
...
void draw_confirm(ui::Canvas& fb, const ConfirmSnapshot& snapshot);
