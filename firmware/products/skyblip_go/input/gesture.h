// products/skyblip_go/input/gesture.h: the gesture that authorises, as pure logic.
//
...
#ifndef SKYBLIP_PRODUCTS_SKYBLIP_GO_INPUT_GESTURE_H
#define SKYBLIP_PRODUCTS_SKYBLIP_GO_INPUT_GESTURE_H
